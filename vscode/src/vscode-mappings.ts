...
export const workbench: Record<string, string> = {
  ...
  'tab.activeBorderTop': p.teal.mid,
  ...
  'tab.unfocusedActiveBorderTop': p.teal.mid + '80',
  ...
  'activityBar.activeBorder': p.teal.mid,
  ...
  // Secondary sidebar (right panel — chat, outline, etc.).
  'secondarySideBar.background': '#1a1d2e',
  'secondarySideBar.foreground': p.base.text,
  'secondarySideBar.border': '#00000000',
  'secondarySideBarTitle.foreground': p.base.inlayHint,
  'secondarySideBarSectionHeader.background': '#1a1d2e',
  'secondarySideBarSectionHeader.foreground': p.base.text,
  'secondarySideBarSectionHeader.border': '#00000000',
  'secondarySideBarActivityBar.background': '#1a1d2e',
  'secondarySideBarActivityBar.border': '#00000000',
  ...
  'statusBar.noFolderBackground': '#1a1d2e',
